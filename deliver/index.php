...
if (isset($_POST['id']) && $_POST['id'] != "") {
    ...
    $id = $_POST['id'];
    $sql3 = "UPDATE purchase SET status=1 WHERE id ='$id'";
        ...
        <div class="container">
            ...
            <div class="table-responsive my-3">
                <table class="table text-capitalize table-hover table-bordered text-center">
                    ...
                    <tbody>
                        <?php
                        $sql2 = "SELECT * FROM purchase WHERE status='0' ORDER BY date ASC";
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" method="POST">
                                        <button class=" btn btn-success text-uppercase" type="submit" name="id" value="<?php echo $row['id']; ?>">deliver</button>
                                    </form>
                                </td>
                            </tr>
                        <?php
