        ...
        <div class="container">
            <div class="table-responsive my-3">
                <table class="table text-capitalize table-hover table-bordered text-center">
                    ...
                    <tbody>
                        <?php
                        $sql2 = "SELECT orders.id, orders.date, orders.delivery_status FROM orders, cart WHERE cart.customer_id='$id' ORDER BY date DESC";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php if($row['delivery_status']==0){
                                    echo 'Pending';
                                }else{
                                    echo 'Delivered';
                                }
                                ...
                                <td>
                                    <form action="./details.php" method="">
                                        <button class=" btn btn-danger text-uppercase" type="submit" name="idp" value="<?php echo $row['id']; ?>">details</button>
                                    </form>
                                </td>
                            </tr>
                        <?php
