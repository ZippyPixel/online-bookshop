...
if (isset($_POST['id']) && $_POST['id'] != "") {
    ...
    $image = base64_encode($row['cover_img']);
    ...
    <section class="main">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="image"><img src="data:image/jpeg;base64,' . base64_encode($row['cover_img']) . '"
                        class="img-fluid" />
                    <div class="name text-capitalize">' . $row['title'] . '</div>
